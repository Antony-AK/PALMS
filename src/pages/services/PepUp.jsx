...
import pepup from "../../assets/pepup.png";
...
const PepUp = () => {
    ...
    return (
            ...
            <div className="max-w-[1280px] mx-auto space-y-28">
                ...
                <div className="relative grid lg:grid-cols-2 gap-14 items-center min-h-[450px]">
                    ...
                    <div className="space-y-8">
                        ...
                        <div className="absolute top-15 right-[57%] z-20 ">

                            <button
                                onClick={() => window.open("https://pepup.co.in", "_blank")}
                                className="
      ...
      text-sm font-medium
      shadow-lg
      hover:scale-105 hover:bg-white transition
    "
                            >
                                Visit PEPUP ↗
                            </button>
